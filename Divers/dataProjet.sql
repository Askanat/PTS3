...
CREATE TABLE personnage (
  ...
  forcePerso float(5,2),
  intelPerso float(5,2),
  constiPerso float(5,2),
  resiPerso float(5,2),
  gold int,
...
CREATE TABLE monstre (
  ...
  coeffArmure float(5,2),
  coeffVie float(5,2),
  coeffMana float(5,2),
  coeffDegat float(5,2),
...
CREATE TABLE item (
  ...
  coeffPotion float(5,2),
  armureItem float(5,2),
  constiItem float(5,2),
  forceItem float(5,2),
  intelItem float(5,2),
  degatItem float(5,2),
